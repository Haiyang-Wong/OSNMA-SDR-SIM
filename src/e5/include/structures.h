...
/*! \brief Exact helper representation for second-of-week accumulation */
typedef struct
{
    int sec;           /*!< Integer seconds inside the week */
    int msec;          /*!< Integer milliseconds inside the current second */
    double sub_msec;   /*!< Fractional part after the millisecond */
} gal_sow_t;
...
typedef struct
{
    ...
    bool set_code_phase;
    double code_phase;
    double code_phase_E5b;
    int ipage_E5b;
    int ibit_E5b;
    int sec_code_idx_E5b_Q;
    int sec_code_idx_E5b_I;
} channel_t;
